                    ...
                    <nav class="navbar navbar-expand-lg align-items-start">
                        ...
                        <div class="collapse navbar-collapse align-items-start collapse" id="karl-navbar">
                            <ul class="navbar-nav animated" id="nav">
                                ...
                                <li class="nav-item"><a class="nav-link" href="/all">All Categories</a></li>
                        ...
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
                                    <h6 data-animation="bounceInDown" data-delay="0" data-duration="500ms">* All New Today</h6>
                                    <h2 data-animation="fadeInUp" data-delay="500ms" data-duration="500ms">Action Movies</h2>
                                    <a href="#" class="btn karl-btn" data-animation="fadeInUp" data-delay="1s" data-duration="500ms">Book Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url(/images/example1.jpeg);">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
                                    <h6 data-animation="fadeInDown" data-delay="0" data-duration="500ms">* Come Watch The Best</h6>
                                    <h2 data-animation="fadeInUp" data-delay="500ms" data-duration="500ms">MovieFix</h2>
                ...
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url(/images/home.jpg);">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
                                    <h6 data-animation="fadeInDown" data-delay="0" data-duration="500ms">* Feel at home with MovieFix</h6>
                                    <h2 data-animation="bounceInDown" data-delay="500ms" data-duration="500ms"></h2>
                                    <a href="#" class="btn karl-btn" data-animation="fadeInRightBig" data-delay="1s" data-duration="500ms">Book Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
